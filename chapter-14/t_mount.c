/* The program provides a command-line interface to the 'mount()' system
   call. In effect, it is a crude version of the 'mount(8)' command. */
...
void main(int argc, char *argv[])
{
   ...
   assert (mount(argv[optind], argv[optind + 1], fstype, flags, 
                 data) != -1);
