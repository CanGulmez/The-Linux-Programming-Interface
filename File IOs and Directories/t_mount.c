/* The program provides a command-level interface to the 'mount' 
   system call. In effect, it is a crude version of the 'mount' 
   command. 
*/
...
void main(int argc, char *argv[])
{
   ...
   if (mount(argv[optind], argv[optind + 1], fstype, flags, data) == -1)
      raiseError("mount() did not work", file, line);
