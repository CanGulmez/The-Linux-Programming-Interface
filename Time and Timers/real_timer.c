...
/* Retrieve and display the real time, and (if 'includeTimer' is TRUE) 
   the current value and interval for the ITIMER_REAL timer. */

void displayTimes(const char *msg, unsigned char includeTimer)
{
